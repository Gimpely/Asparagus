...
class motion_planning:
	...
	def callback_track_pose(self, data):
		...
		# print("inv 0")
		qd_radians = deltaInvKin(self.next_point[0], self.next_point[1], self.next_point[2])
		...
		if status > 0 and self.pub_idx == 1:
			...
			# print("inv 1")
			qd_radians= deltaInvKin(r_control[0], r_control[1], r_control[2])
	...
	def robot_motion(self):
		...
		if self.step_motion == 0:
			...
			# print("inv 3")
			qd_radians[:3]= deltaInvKin(temp[0], temp[1], temp[2])
